...
$(document).ready(function () {
  ...
  let processProperty = () => {
    ...
    document.getElementById("currency").innerHTML =
      property.internationalCurrency;
    ...
    document.getElementById("tranchesleft").innerHTML =
      property.tranches - property.tranchesSold;
    document.getElementById("tranchecost").innerHTML = tranchePrice;
  };

  let getProperty = () => {
    //TODO get the property from the new admin
    //TODO have a local / prod mode
    propertyId = getUrlParamater("id");
    fetch(apiUrl + `properties/crowdfund/?id=${propertyId}`)
